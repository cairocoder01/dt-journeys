...
/**
 * Class Dt_Journeys_Menu
 */
class Dt_Journeys_Menu {

    public $token = 'dt_journeys';
    public $page_title = 'Journeys';

    private static $_instance = null;

    /**
     * Dt_Journeys_Menu Instance
     *
     * Ensures only one instance of Dt_Journeys_Menu is loaded or can be loaded.
     *
     * @since 0.1.0
     * @static
     * @return Dt_Journeys_Menu instance
     */
    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            switch ( $tab ) {
                case 'general':
                    $object = new Dt_Journeys_Tab_General();
                    $object->content();
                    break;
                case 'second':
                    $object = new Dt_Journeys_Tab_Second();
                    $object->content();
                    break;
                default:
                    break;
...
class Dt_Journeys_Tab_General {
    ...
    public function main_column() {
        $token = Dt_Journeys_Menu::instance()->token;
