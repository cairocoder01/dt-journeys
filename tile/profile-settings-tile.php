...
/**
 * Class Dt_Journeys_Settings_Tile
 *
...
class Dt_Journeys_Settings_Tile
{
    ...
    public function dt_profile_settings_page_menu( $dt_user, $dt_user_meta, $dt_user_contact_id, $contact_fields ) {
        ?>
        <li><a href="#dt_journeys_settings_id"><?php esc_html_e( 'Custom Settings Section', 'dt-journeys' )?></a></li>
        <?php
    }
    ...
    public function dt_profile_settings_page_sections( $dt_user, $dt_user_meta, $dt_user_contact_id, $contact_fields ) {
        ?>
        <div class="cell bordered-box" id="dt_journeys_settings_id" data-magellan-target="dt_journeys_settings_id">
            <button class="help-button float-right" data-section="dt-journeys-help-text">
                <img class="help-icon" src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/images/help.svg' ) ?>"/>
            </button>
            <span class="section-header"><?php esc_html_e( 'Custom Settings Section', 'dt-journeys' )?></span>
            <hr/>
    ...
    public function dt_modal_help_text(){
        ?>
        <div class="help-section" id="dt-journeys-help-text" style="display: none">
            <h3><?php echo esc_html_x( 'Custom Settings Section', 'Optional Documentation', 'dt-journeys' ) ?></h3>
            <p><?php echo esc_html_x( 'Add your own help information into this modal.', 'Optional Documentation', 'dt-journeys' ) ?></p>
        </div>
        <?php
    }
}

Dt_Journeys_Settings_Tile::instance();
