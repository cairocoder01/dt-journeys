    ...
    public function enqueue_scripts() {
        ...
        wp_localize_script( 'dt-journeys-tile', 'dtJourneys', [
            ...
            'i18n'      => [
                ...
                'remove_journey'   => __( 'Remove Journey', 'dt-journeys' ),
                'confirm_remove'   => __( 'Remove this journey and its progress from this record? This cannot be undone.', 'dt-journeys' ),
