...
/**
 * Class Dt_Journeys_Magic_Link
 */
class Dt_Journeys_Magic_Link extends DT_Magic_Url_Base {
    ...
    public $post_type = 'dt_journeys_post_type'; // @todo set the post type this magic link connects with.
    private $meta_key = '';
...
Dt_Journeys_Magic_Link::instance();
